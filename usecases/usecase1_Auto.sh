...
qemu-system-aarch64 \
      ...
      -append "console=hvc0 root=/dev/vda1 rw autorun=usecase1_realm_A_Auto.sh" < /dev/hvc1 >/dev/hvc1 &
...
qemu-system-aarch64 \
      ...
      -cpu host -M virt -enable-kvm -M gic-version=3,its=on \
      -smp 1 -m 512M -nographic \
      -append "console=hvc0 root=/dev/vda1 rw autorun=usecase1_realm_B_Auto.sh" < /dev/hvc2 >/dev/hvc2 &
...
qemu-system-aarch64 \
      ...
      -cpu host -M virt -enable-kvm -M gic-version=3,its=on \
      -smp 1 -m 512M -nographic \
      -append "console=hvc0 root=/dev/vda1 rw autorun=usecase1_realm_C_Auto.sh" < /dev/hvc3 >/dev/hvc3 &
...
qemu-system-aarch64 \
      ...
      -cpu host -M virt -enable-kvm -M gic-version=3,its=on \
      -smp 1 -m 512M -nographic \
      -append "console=hvc0 root=/dev/vda1 rw autorun=usecase1_realm_D_Auto.sh" < /dev/hvc4 >/dev/hvc4 &
