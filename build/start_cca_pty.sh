...
SESSION="tcp_session"
PORTS=(54320 54321 54322 54323 54324)
NAMES=("firmware" "secure_payload" "host" "realm1" "realm2")
PTYS=(/tmp/firmware_pty /tmp/secure_payload_pty /tmp/host_pty /tmp/realm1_pty /tmp/realm2_pty)
